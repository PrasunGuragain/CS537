...
8010041a:	e8 91 5a 00 00       	call   80105eb0 <uartputc>
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 07 65 00 00       	call   80107040 <setupkvm>
...
80100ba3:	e8 b8 62 00 00       	call   80106e60 <allocuvm>
...
80100bd9:	e8 92 61 00 00       	call   80106d70 <loaduvm>
...
80100c1b:	e8 a0 63 00 00       	call   80106fc0 <freevm>
  if(ip){
...
80100c81:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 58 64 00 00       	call   801070e0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100d11:	e8 aa 62 00 00       	call   80106fc0 <freevm>
...
80100dcd:	e8 0e 5e 00 00       	call   80106be0 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 e6 61 00 00       	call   80106fc0 <freevm>
  return 0;
...
80103022:	e8 b9 2a 00 00       	call   80105ae0 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 85 3b 00 00       	call   80106bd0 <switchkvm>
  seginit();
8010304b:	e8 f0 3a 00 00       	call   80106b40 <seginit>
  lapicinit();
...
80103081:	e8 3a 40 00 00       	call   801070c0 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 ab 3a 00 00       	call   80106b40 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 27 2d 00 00       	call   80105dd0 <uartinit>
  pinit();         // process table
801030a9:	e8 32 08 00 00       	call   801038e0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 ad 29 00 00       	call   80105a60 <tvinit>
  binit();         // buffer cache
...
801037d6:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
...
801037f7:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037fa:	68 40 1d 11 80       	push   $0x80111d40
  p->pid = nextpid++;
...
80103827:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382a:	c7 40 14 52 5a 10 80 	movl   $0x80105a52,0x14(%eax)
  p->context = (struct context*)sp;
...
8010385b:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
8010385d:	68 40 1d 11 80       	push   $0x80111d40
...
80103893:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103896:	68 40 1d 11 80       	push   $0x80111d40
...
80103964:	53                   	push   %ebx
  struct cpu *c = mycpu();
80103965:	e8 96 ff ff ff       	call   80103900 <mycpu>
        pstate->inuse[i] = 1;
8010396a:	8b 1d 20 1d 11 80    	mov    0x80111d20,%ebx
  int i = 0;
80103970:	31 d2                	xor    %edx,%edx
  c->proc = 0;
80103972:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103979:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010397c:	b8 74 1d 11 80       	mov    $0x80111d74,%eax
80103981:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if (p->state != UNUSED){ // perhaps needs to be running 
80103988:	8b 70 0c             	mov    0xc(%eax),%esi
8010398b:	31 c9                	xor    %ecx,%ecx
8010398d:	85 f6                	test   %esi,%esi
8010398f:	0f 95 c1             	setne  %cl
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103992:	05 84 00 00 00       	add    $0x84,%eax
        pstate->inuse[i] = 1;
80103997:	89 0c 93             	mov    %ecx,(%ebx,%edx,4)
      pstate->tickets[i] = p->priority;
8010399a:	8b 1d 20 1d 11 80    	mov    0x80111d20,%ebx
801039a0:	8b 70 f8             	mov    -0x8(%eax),%esi
801039a3:	8d 0c 93             	lea    (%ebx,%edx,4),%ecx
      i++;
801039a6:	83 c2 01             	add    $0x1,%edx
      pstate->tickets[i] = p->priority;
801039a9:	89 b1 00 01 00 00    	mov    %esi,0x100(%ecx)
      pstate->pid[i] = p->pid;
801039af:	8b 70 8c             	mov    -0x74(%eax),%esi
801039b2:	89 b1 00 02 00 00    	mov    %esi,0x200(%ecx)
      pstate->ticks[i] = p->run_ticks;
801039b8:	8b 70 fc             	mov    -0x4(%eax),%esi
801039bb:	89 b1 00 03 00 00    	mov    %esi,0x300(%ecx)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039c1:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
801039c6:	75 c0                	jne    80103988 <iterate_ptable+0x28>
}
...
801039d3:	83 ec 08             	sub    $0x8,%esp
  return mycpu()-cpus;
801039d6:	e8 25 ff ff ff       	call   80103900 <mycpu>
}
801039db:	c9                   	leave  
  return mycpu()-cpus;
...
801039f4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801039f7:	e8 74 0b 00 00       	call   80104570 <pushcli>
  c = mycpu();
801039fc:	e8 ff fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103a01:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a07:	e8 b4 0b 00 00       	call   801045c0 <popcli>
}
...
80103a2c:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103a2e:	a3 74 3e 11 80       	mov    %eax,0x80113e74
...
80103a66:	e8 15 0d 00 00       	call   80104780 <memset>
...
80103abf:	68 10 79 10 80       	push   $0x80107910
80103ac4:	50                   	push   %eax
80103ac5:	e8 76 0e 00 00       	call   80104940 <safestrcpy>
  p->cwd = namei("/");
80103aca:	c7 04 24 19 79 10 80 	movl   $0x80107919,(%esp)
80103ad1:	e8 ca e5 ff ff       	call   801020a0 <namei>
80103ad6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103ad9:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
80103ae0:	e8 db 0b 00 00       	call   801046c0 <acquire>
  p->state = RUNNABLE;
80103ae5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103aec:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
...
80103b03:	68 f7 78 10 80       	push   $0x801078f7
...
80103b15:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103b18:	e8 53 0a 00 00       	call   80104570 <pushcli>
  c = mycpu();
80103b1d:	e8 de fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b22:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b28:	e8 93 0a 00 00       	call   801045c0 <popcli>
  sz = curproc->sz;
...
80103b5a:	e8 01 33 00 00       	call   80106e60 <allocuvm>
...
80103b96:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b99:	e8 d2 09 00 00       	call   80104570 <pushcli>
  c = mycpu();
80103b9e:	e8 5d fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ba3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ba9:	e8 12 0a 00 00       	call   801045c0 <popcli>
  if((np = allocproc()) == 0){
...
80103c41:	e8 fa 0c 00 00       	call   80104940 <safestrcpy>
  pid = np->pid;
80103c46:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103c49:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
80103c50:	e8 6b 0a 00 00       	call   801046c0 <acquire>
  np->state = RUNNABLE;
80103c55:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103c5c:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
80103c63:	e8 f8 09 00 00       	call   80104660 <release>
  return pid;
...
80103cd1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cd4:	bb 74 1d 11 80       	mov    $0x80111d74,%ebx
    acquire(&ptable.lock);
80103cd9:	68 40 1d 11 80       	push   $0x80111d40
80103cde:	e8 dd 09 00 00       	call   801046c0 <acquire>
...
80103cf4:	75 46                	jne    80103d3c <scheduler+0x8c>
80103cf6:	8b 53 7c             	mov    0x7c(%ebx),%edx
80103cf9:	85 d2                	test   %edx,%edx
80103cfb:	74 3f                	je     80103d3c <scheduler+0x8c>
      switchuvm(p);
80103cfd:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103d00:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
80103d06:	53                   	push   %ebx
80103d07:	e8 d4 2e 00 00       	call   80106be0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103d0c:	59                   	pop    %ecx
80103d0d:	58                   	pop    %eax
80103d0e:	ff 73 1c             	push   0x1c(%ebx)
80103d11:	57                   	push   %edi
      p->run_ticks++;
80103d12:	83 83 80 00 00 00 01 	addl   $0x1,0x80(%ebx)
      p->state = RUNNING;
80103d19:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103d20:	e8 76 0c 00 00       	call   8010499b <swtch>
      switchkvm();
80103d25:	e8 a6 2e 00 00       	call   80106bd0 <switchkvm>
      c->proc = 0;
80103d2a:	83 c4 10             	add    $0x10,%esp
      first_loop = 1;
80103d2d:	b8 01 00 00 00       	mov    $0x1,%eax
      c->proc = 0;
80103d32:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103d39:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d3c:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103d42:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
80103d48:	75 a6                	jne    80103cf0 <scheduler+0x40>
    release(&ptable.lock);
80103d4a:	83 ec 0c             	sub    $0xc,%esp
80103d4d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103d50:	68 40 1d 11 80       	push   $0x80111d40
80103d55:	e8 06 09 00 00       	call   80104660 <release>
    if (first_loop == 0){
80103d5a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103d5d:	83 c4 10             	add    $0x10,%esp
80103d60:	85 c0                	test   %eax,%eax
80103d62:	0f 85 68 ff ff ff    	jne    80103cd0 <scheduler+0x20>
        acquire(&ptable.lock);
80103d68:	83 ec 0c             	sub    $0xc,%esp
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d6b:	bb 74 1d 11 80       	mov    $0x80111d74,%ebx
        acquire(&ptable.lock);
80103d70:	68 40 1d 11 80       	push   $0x80111d40
80103d75:	e8 46 09 00 00       	call   801046c0 <acquire>
...
80103d84:	75 40                	jne    80103dc6 <scheduler+0x116>
80103d86:	83 7b 7c 01          	cmpl   $0x1,0x7c(%ebx)
80103d8a:	74 3a                	je     80103dc6 <scheduler+0x116>
        switchuvm(p);
80103d8c:	83 ec 0c             	sub    $0xc,%esp
        c->proc = p;
80103d8f:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
        switchuvm(p);
80103d95:	53                   	push   %ebx
80103d96:	e8 45 2e 00 00       	call   80106be0 <switchuvm>
        swtch(&(c->scheduler), p->context);
80103d9b:	58                   	pop    %eax
80103d9c:	5a                   	pop    %edx
80103d9d:	ff 73 1c             	push   0x1c(%ebx)
80103da0:	57                   	push   %edi
        p->run_ticks++;
80103da1:	83 83 80 00 00 00 01 	addl   $0x1,0x80(%ebx)
        p->state = RUNNING;
80103da8:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
        swtch(&(c->scheduler), p->context);
80103daf:	e8 e7 0b 00 00       	call   8010499b <swtch>
        switchkvm();
80103db4:	e8 17 2e 00 00       	call   80106bd0 <switchkvm>
        c->proc = 0;
80103db9:	83 c4 10             	add    $0x10,%esp
80103dbc:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103dc3:	00 00 00 
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dc6:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103dcc:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
80103dd2:	75 ac                	jne    80103d80 <scheduler+0xd0>
        release(&ptable.lock);
80103dd4:	83 ec 0c             	sub    $0xc,%esp
80103dd7:	68 40 1d 11 80       	push   $0x80111d40
80103ddc:	e8 7f 08 00 00       	call   80104660 <release>
80103de1:	83 c4 10             	add    $0x10,%esp
80103de4:	e9 e7 fe ff ff       	jmp    80103cd0 <scheduler+0x20>
...
80103df5:	e8 76 07 00 00       	call   80104570 <pushcli>
  c = mycpu();
80103dfa:	e8 01 fb ff ff       	call   80103900 <mycpu>
  p = c->proc;
...
80103e0d:	68 40 1d 11 80       	push   $0x80111d40
...
80103e1c:	74 4f                	je     80103e6d <sched+0x7d>
  if(mycpu()->ncli != 1)
80103e1e:	e8 dd fa ff ff       	call   80103900 <mycpu>
...
80103e37:	75 41                	jne    80103e7a <sched+0x8a>
  intena = mycpu()->intena;
80103e39:	e8 c2 fa ff ff       	call   80103900 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e3e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103e41:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e47:	e8 b4 fa ff ff       	call   80103900 <mycpu>
...
80103e53:	e8 43 0b 00 00       	call   8010499b <swtch>
  mycpu()->intena = intena;
80103e58:	e8 a3 fa ff ff       	call   80103900 <mycpu>
}
...
80103eb6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103eb9:	e8 32 fb ff ff       	call   801039f0 <myproc>
  if(curproc == initproc)
80103ebe:	39 05 74 3e 11 80    	cmp    %eax,0x80113e74
...
80103f0c:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103f13:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
...
80103f53:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
80103f58:	75 e2                	jne    80103f3c <exit+0x8c>
      p->parent = initproc;
80103f5a:	8b 0d 74 3e 11 80    	mov    0x80113e74,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f60:	ba 74 1d 11 80       	mov    $0x80111d74,%edx
...
80103f76:	81 fa 74 3e 11 80    	cmp    $0x80113e74,%edx
...
80103fc7:	68 68 79 10 80       	push   $0x80107968
80103fcc:	e8 af c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103fd1:	83 ec 0c             	sub    $0xc,%esp
80103fd4:	68 5b 79 10 80       	push   $0x8010795b
...
80104037:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010403c:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
...
80104057:	e8 14 05 00 00       	call   80104570 <pushcli>
  c = mycpu();
8010405c:	e8 9f f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
...
801040a9:	e8 12 2f 00 00       	call   80106fc0 <freevm>
        p->pid = 0;
...
801040c7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040ce:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
...
801040e9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040ee:	68 40 1d 11 80       	push   $0x80111d40
...
8010413d:	e8 ae fc ff ff       	call   80103df0 <sched>
  release(&ptable.lock);
80104142:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
...
8010416f:	e8 fc 03 00 00       	call   80104570 <pushcli>
  c = mycpu();
80104174:	e8 87 f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
...
80104190:	81 fe 40 1d 11 80    	cmp    $0x80111d40,%esi
80104196:	74 50                	je     801041e8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104198:	83 ec 0c             	sub    $0xc,%esp
8010419b:	68 40 1d 11 80       	push   $0x80111d40
...
801041bc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801041c3:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
...
80104245:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
...
80104263:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
80104268:	75 e2                	jne    8010424c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010426a:	c7 45 08 40 1d 11 80 	movl   $0x80111d40,0x8(%ebp)
}
...
801042c8:	68 40 1d 11 80       	push   $0x80111d40
...
801042e3:	68 40 1d 11 80       	push   $0x80111d40
...
80104309:	bb e0 1d 11 80       	mov    $0x80111de0,%ebx
...
8010432e:	81 fb e0 3e 11 80    	cmp    $0x80113ee0,%ebx
...
8010433f:	74 e7                	je     80104328 <procdump+0x28>
      state = "???";
80104341:	ba 8b 79 10 80       	mov    $0x8010798b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104346:	83 f8 05             	cmp    $0x5,%eax
80104349:	77 11                	ja     8010435c <procdump+0x5c>
8010434b:	8b 14 85 ec 79 10 80 	mov    -0x7fef8614(,%eax,4),%edx
      state = "???";
80104352:	b8 8b 79 10 80       	mov    $0x8010798b,%eax
...
80104361:	68 8f 79 10 80       	push   $0x8010798f
...
80104433:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104439:	e8 b2 f5 ff ff       	call   801039f0 <myproc>
...
801044db:	e8 10 f5 ff ff       	call   801039f0 <myproc>
...
801049b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801049ba:	e8 31 f0 ff ff       	call   801039f0 <myproc>
...
801049f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801049fa:	e8 f1 ef ff ff       	call   801039f0 <myproc>
...
80104a45:	e8 a6 ef ff ff       	call   801039f0 <myproc>
...
80104a53:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a56:	e8 95 ef ff ff       	call   801039f0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a96:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104a99:	e8 52 ef ff ff       	call   801039f0 <myproc>
80104a9e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104aa0:	e8 4b ef ff ff       	call   801039f0 <myproc>
...
80104aae:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ab1:	e8 3a ef ff ff       	call   801039f0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b04:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b05:	e8 e6 ee ff ff       	call   801039f0 <myproc>
...
80104b13:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b16:	e8 d5 ee ff ff       	call   801039f0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b2b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104b2e:	e8 bd ee ff ff       	call   801039f0 <myproc>
  if(addr >= curproc->sz)
...
80104b84:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b87:	e8 64 ee ff ff       	call   801039f0 <myproc>
...
80104d90 <sys_settickets>:
{  
80104d90:	55                   	push   %ebp
80104d91:	89 e5                	mov    %esp,%ebp
80104d93:	53                   	push   %ebx
80104d94:	83 ec 14             	sub    $0x14,%esp
    struct proc* curr_proc = myproc();
80104d97:	e8 54 ec ff ff       	call   801039f0 <myproc>
...
80104da7:	e8 94 fc ff ff       	call   80104a40 <argint>
80104dac:	83 c4 10             	add    $0x10,%esp
80104daf:	85 c0                	test   %eax,%eax
80104db1:	78 2d                	js     80104de0 <sys_settickets+0x50>
    if (ticket < 0 || ticket > 1){
80104db3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104db6:	83 f8 01             	cmp    $0x1,%eax
80104db9:	77 25                	ja     80104de0 <sys_settickets+0x50>
    if (ticket == 0){
80104dbb:	85 c0                	test   %eax,%eax
80104dbd:	75 11                	jne    80104dd0 <sys_settickets+0x40>
        curr_proc -> priority = 0;
80104dbf:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
}
...
{
80104df8:	83 ec 14             	sub    $0x14,%esp
    if(argptr(0, (void*)&curr_state, sizeof(*curr_state)) < 0){
80104dfb:	68 00 04 00 00       	push   $0x400
80104e00:	50                   	push   %eax
80104e01:	6a 00                	push   $0x0
80104e03:	e8 88 fc ff ff       	call   80104a90 <argptr>
80104e08:	83 c4 10             	add    $0x10,%esp
80104e0b:	85 c0                	test   %eax,%eax
80104e0d:	78 55                	js     80104e64 <sys_getpinfo+0x74>
    struct pstat* p_state = iterate_ptable();
80104e0f:	e8 4c eb ff ff       	call   80103960 <iterate_ptable>
        curr_state->inuse[i] = p_state->inuse[i];
80104e14:	8b 5d f4             	mov    -0xc(%ebp),%ebx
    struct pstat* p_state = iterate_ptable();
...
80104e1f:	90                   	nop
        curr_state->inuse[i] = p_state->inuse[i];
80104e20:	8b 0c 82             	mov    (%edx,%eax,4),%ecx
80104e23:	89 0c 83             	mov    %ecx,(%ebx,%eax,4)
        curr_state->pid[i] = p_state->pid[i];
80104e26:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80104e29:	8b b4 82 00 02 00 00 	mov    0x200(%edx,%eax,4),%esi
80104e30:	8d 0c 83             	lea    (%ebx,%eax,4),%ecx
80104e33:	89 b1 00 02 00 00    	mov    %esi,0x200(%ecx)
        curr_state->tickets[i] = p_state->tickets[i];
80104e39:	8b b4 82 00 01 00 00 	mov    0x100(%edx,%eax,4),%esi
80104e40:	89 b1 00 01 00 00    	mov    %esi,0x100(%ecx)
        curr_state->ticks[i] = p_state->ticks[i];
80104e46:	8b b4 82 00 03 00 00 	mov    0x300(%edx,%eax,4),%esi
    for(int i = 0; i < NPROC; i++){
80104e4d:	83 c0 01             	add    $0x1,%eax
        curr_state->ticks[i] = p_state->ticks[i];
80104e50:	89 b1 00 03 00 00    	mov    %esi,0x300(%ecx)
    for(int i = 0; i < NPROC; i++){
80104e56:	83 f8 40             	cmp    $0x40,%eax
80104e59:	75 c5                	jne    80104e20 <sys_getpinfo+0x30>
    return 0;
...
80104e69:	eb f2                	jmp    80104e5d <sys_getpinfo+0x6d>
...
80104e9e:	74 20                	je     80104ec0 <sys_dup+0x50>
  struct proc *curproc = myproc();
80104ea0:	e8 4b eb ff ff       	call   801039f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104f10:	e8 db ea ff ff       	call   801039f0 <myproc>
...
80104f29:	e8 12 fb ff ff       	call   80104a40 <argint>
...
80104f3e:	e8 4d fb ff ff       	call   80104a90 <argptr>
...
80104f90:	e8 5b ea ff ff       	call   801039f0 <myproc>
...
80104fa9:	e8 92 fa ff ff       	call   80104a40 <argint>
...
80104fbe:	e8 cd fa ff ff       	call   80104a90 <argptr>
...
80104ffe:	e8 3d fa ff ff       	call   80104a40 <argint>
...
80105010:	e8 db e9 ff ff       	call   801039f0 <myproc>
...
80105021:	74 25                	je     80105048 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105023:	e8 c8 e9 ff ff       	call   801039f0 <myproc>
  fileclose(f);
...
8010505e:	e8 dd f9 ff ff       	call   80104a40 <argint>
...
80105070:	e8 7b e9 ff ff       	call   801039f0 <myproc>
...
80105088:	e8 03 fa ff ff       	call   80104a90 <argptr>
...
801050cf:	e8 2c fa ff ff       	call   80104b00 <argstr>
...
801050e8:	e8 13 fa ff ff       	call   80104b00 <argstr>
...
8010521f:	e8 dc f8 ff ff       	call   80104b00 <argstr>
...
8010525d:	58                   	pop    %eax
8010525e:	5a                   	pop    %edx
8010525f:	68 dc 7a 10 80       	push   $0x80107adc
...
80105278:	68 db 7a 10 80       	push   $0x80107adb
...
801052d2:	e8 a9 f4 ff ff       	call   80104780 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
801053ff:	e8 fc f6 ff ff       	call   80104b00 <argstr>
...
80105418:	e8 23 f6 ff ff       	call   80104a40 <argint>
...
80105467:	74 23                	je     8010548c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105469:	e8 82 e5 ff ff       	call   801039f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801054b7:	e8 34 f7 ff ff       	call   80104bf0 <create>
    if(ip == 0){
...
80105544:	e8 b7 f5 ff ff       	call   80104b00 <argstr>
...
8010555f:	e8 8c f6 ff ff       	call   80104bf0 <create>
...
801055a4:	e8 57 f5 ff ff       	call   80104b00 <argstr>
...
801055b9:	e8 82 f4 ff ff       	call   80104a40 <argint>
  if((argstr(0, &path)) < 0 ||
...
801055ce:	e8 6d f4 ff ff       	call   80104a40 <argint>
     argint(1, &major) < 0 ||
...
801055ee:	e8 fd f5 ff ff       	call   80104bf0 <create>
     argint(2, &minor) < 0 ||
...
80105625:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105628:	e8 c3 e3 ff ff       	call   801039f0 <myproc>
...
8010563d:	e8 be f4 ff ff       	call   80104b00 <argstr>
...
801056e5:	e8 16 f4 ff ff       	call   80104b00 <argstr>
...
80105701:	e8 3a f3 ff ff       	call   80104a40 <argint>
...
80105720:	e8 5b f0 ff ff       	call   80104780 <memset>
...
8010574a:	e8 61 f2 ff ff       	call   801049b0 <fetchint>
...
80105768:	e8 83 f2 ff ff       	call   801049f0 <fetchstr>
...
801057d1:	e8 ba f2 ff ff       	call   80104a90 <argptr>
...
801057f7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801057f9:	e8 f2 e1 ff ff       	call   801039f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105837:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010583a:	e8 b1 e1 ff ff       	call   801039f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105856:	75 f0                	jne    80105848 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105858:	e8 93 e1 ff ff       	call   801039f0 <myproc>
...
{
  return fork();
80105890:	e9 fb e2 ff ff       	jmp    80103b90 <fork>
...
801058a3:	83 ec 08             	sub    $0x8,%esp
  exit();
801058a6:	e8 05 e6 ff ff       	call   80103eb0 <exit>
...
{
  return wait();
801058b0:	e9 2b e7 ff ff       	jmp    80103fe0 <wait>
...
801058cc:	e8 6f f1 ff ff       	call   80104a40 <argint>
...
801058de:	e8 9d e9 ff ff       	call   80104280 <kill>
...
80105903:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105906:	e8 e5 e0 ff ff       	call   801039f0 <myproc>
...
80105936:	e8 d5 e1 ff ff       	call   80103b10 <growproc>
...
8010596d:	e8 ce f0 ff ff       	call   80104a40 <argint>
...
80105980:	68 a0 3e 11 80       	push   $0x80113ea0
80105985:	e8 36 ed ff ff       	call   801046c0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010598a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010598d:	8b 1d 80 3e 11 80    	mov    0x80113e80,%ebx
  while(ticks - ticks0 < n){
...
801059a3:	68 a0 3e 11 80       	push   $0x80113ea0
801059a8:	68 80 3e 11 80       	push   $0x80113e80
801059ad:	e8 ae e7 ff ff       	call   80104160 <sleep>
  while(ticks - ticks0 < n){
801059b2:	a1 80 3e 11 80       	mov    0x80113e80,%eax
...
801059bf:	73 2f                	jae    801059f0 <sys_sleep+0x90>
    if(myproc()->killed){
801059c1:	e8 2a e0 ff ff       	call   801039f0 <myproc>
...
801059d0:	68 a0 3e 11 80       	push   $0x80113ea0
801059d5:	e8 86 ec ff ff       	call   80104660 <release>
  }
  release(&tickslock);
  return 0;
}
...
801059f3:	68 a0 3e 11 80       	push   $0x80113ea0
801059f8:	e8 63 ec ff ff       	call   80104660 <release>
  return 0;
...
80105a14:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105a17:	68 a0 3e 11 80       	push   $0x80113ea0
80105a1c:	e8 9f ec ff ff       	call   801046c0 <acquire>
  xticks = ticks;
80105a21:	8b 1d 80 3e 11 80    	mov    0x80113e80,%ebx
  release(&tickslock);
80105a27:	c7 04 24 a0 3e 11 80 	movl   $0x80113ea0,(%esp)
80105a2e:	e8 2d ec ff ff       	call   80104660 <release>
  return xticks;
}
...
80105a77:	c7 04 c5 e2 3e 11 80 	movl   $0x8e000008,-0x7feec11e(,%eax,8)
80105a7e:	08 00 00 8e 
80105a82:	66 89 14 c5 e0 3e 11 	mov    %dx,-0x7feec120(,%eax,8)
80105a89:	80 
80105a8a:	c1 ea 10             	shr    $0x10,%edx
80105a8d:	66 89 14 c5 e6 3e 11 	mov    %dx,-0x7feec11a(,%eax,8)
80105a94:	80 
  for(i = 0; i < 256; i++)
...
80105aa7:	c7 05 e2 40 11 80 08 	movl   $0xef000008,0x801140e2
80105aae:	00 00 ef 
  initlock(&tickslock, "time");
80105ab1:	68 21 7b 10 80       	push   $0x80107b21
80105ab6:	68 a0 3e 11 80       	push   $0x80113ea0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105abb:	66 a3 e0 40 11 80    	mov    %ax,0x801140e0
80105ac1:	c1 e8 10             	shr    $0x10,%eax
80105ac4:	66 a3 e6 40 11 80    	mov    %ax,0x801140e6
  initlock(&tickslock, "time");
...
80105aeb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105aef:	b8 e0 3e 11 80       	mov    $0x80113ee0,%eax
...
80105b34:	ff 24 85 c8 7b 10 80 	jmp    *-0x7fef8438(,%eax,4)
...
80105b3f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105b40:	e8 fb c6 ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
80105b4a:	e8 a1 de ff ff       	call   801039f0 <myproc>
80105b4f:	85 c0                	test   %eax,%eax
80105b51:	74 1d                	je     80105b70 <trap+0x60>
80105b53:	e8 98 de ff ff       	call   801039f0 <myproc>
...
80105b79:	e8 72 de ff ff       	call   801039f0 <myproc>
...
80105b82:	0f 84 b8 00 00 00    	je     80105c40 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b88:	e8 63 de ff ff       	call   801039f0 <myproc>
80105b8d:	85 c0                	test   %eax,%eax
80105b8f:	74 1d                	je     80105bae <trap+0x9e>
80105b91:	e8 5a de ff ff       	call   801039f0 <myproc>
...
80105bc0:	e8 2b de ff ff       	call   801039f0 <myproc>
...
80105be0:	e8 eb dd ff ff       	call   801039d0 <cpuid>
...
80105bf1:	e8 fa dd ff ff       	call   801039f0 <myproc>
...
80105c15:	68 84 7b 10 80       	push   $0x80107b84
80105c1a:	e8 81 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105c1f:	83 c4 20             	add    $0x20,%esp
80105c22:	e8 c9 dd ff ff       	call   801039f0 <myproc>
80105c27:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c2e:	e8 bd dd ff ff       	call   801039f0 <myproc>
...
80105c5f:	e8 6c dd ff ff       	call   801039d0 <cpuid>
80105c64:	57                   	push   %edi
80105c65:	56                   	push   %esi
80105c66:	50                   	push   %eax
80105c67:	68 2c 7b 10 80       	push   $0x80107b2c
80105c6c:	e8 2f aa ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105c71:	e8 9a cc ff ff       	call   80102910 <lapiceoi>
    break;
80105c76:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c79:	e8 72 dd ff ff       	call   801039f0 <myproc>
...
80105cec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105cf0:	e8 db ca ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105cf5:	e8 16 cc ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cfa:	e8 f1 dc ff ff       	call   801039f0 <myproc>
...
80105d0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105d10:	e8 bb dc ff ff       	call   801039d0 <cpuid>
80105d15:	85 c0                	test   %eax,%eax
80105d17:	0f 85 28 fe ff ff    	jne    80105b45 <trap+0x35>
      acquire(&tickslock);
80105d1d:	83 ec 0c             	sub    $0xc,%esp
80105d20:	68 a0 3e 11 80       	push   $0x80113ea0
80105d25:	e8 96 e9 ff ff       	call   801046c0 <acquire>
      wakeup(&ticks);
80105d2a:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
      ticks++;
80105d31:	83 05 80 3e 11 80 01 	addl   $0x1,0x80113e80
      wakeup(&ticks);
80105d38:	e8 e3 e4 ff ff       	call   80104220 <wakeup>
      release(&tickslock);
80105d3d:	c7 04 24 a0 3e 11 80 	movl   $0x80113ea0,(%esp)
...
80105d75:	e8 56 dc ff ff       	call   801039d0 <cpuid>
80105d7a:	83 ec 0c             	sub    $0xc,%esp
80105d7d:	56                   	push   %esi
80105d7e:	57                   	push   %edi
80105d7f:	50                   	push   %eax
80105d80:	ff 73 30             	push   0x30(%ebx)
80105d83:	68 50 7b 10 80       	push   $0x80107b50
80105d88:	e8 13 a9 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105d8d:	83 c4 14             	add    $0x14,%esp
80105d90:	68 26 7b 10 80       	push   $0x80107b26
...
{
  if(!uart)
80105da0:	a1 e0 46 11 80       	mov    0x801146e0,%eax
...
80105e27:	74 78                	je     80105ea1 <uartinit+0xd1>
  uart = 1;
80105e29:	c7 05 e0 46 11 80 01 	movl   $0x1,0x801146e0
80105e30:	00 00 00 
...
80105e3c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e3f:	bf 48 7c 10 80       	mov    $0x80107c48,%edi
80105e44:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105e49:	6a 00                	push   $0x0
80105e4b:	6a 04                	push   $0x4
80105e4d:	e8 2e c6 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105e52:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
80105e56:	83 c4 10             	add    $0x10,%esp
80105e59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105e60:	a1 e0 46 11 80       	mov    0x801146e0,%eax
...
80105eb0 <uartputc>:
  if(!uart)
80105eb0:	a1 e0 46 11 80       	mov    0x801146e0,%eax
...
80105f1b:	e8 60 a9 ff ff       	call   80100880 <consoleintr>
}
...
80105f27:	6a 00                	push   $0x0
  jmp alltraps
80105f29:	e9 0c fb ff ff       	jmp    80105a3a <alltraps>
...
80105f30:	6a 01                	push   $0x1
  jmp alltraps
80105f32:	e9 03 fb ff ff       	jmp    80105a3a <alltraps>
...
80105f39:	6a 02                	push   $0x2
  jmp alltraps
80105f3b:	e9 fa fa ff ff       	jmp    80105a3a <alltraps>
...
80105f42:	6a 03                	push   $0x3
  jmp alltraps
80105f44:	e9 f1 fa ff ff       	jmp    80105a3a <alltraps>
...
80105f4b:	6a 04                	push   $0x4
  jmp alltraps
80105f4d:	e9 e8 fa ff ff       	jmp    80105a3a <alltraps>
...
80105f54:	6a 05                	push   $0x5
  jmp alltraps
80105f56:	e9 df fa ff ff       	jmp    80105a3a <alltraps>
...
80105f5d:	6a 06                	push   $0x6
  jmp alltraps
80105f5f:	e9 d6 fa ff ff       	jmp    80105a3a <alltraps>
...
80105f66:	6a 07                	push   $0x7
  jmp alltraps
80105f68:	e9 cd fa ff ff       	jmp    80105a3a <alltraps>
...
80105f6d:	6a 08                	push   $0x8
  jmp alltraps
80105f6f:	e9 c6 fa ff ff       	jmp    80105a3a <alltraps>
...
80105f76:	6a 09                	push   $0x9
  jmp alltraps
80105f78:	e9 bd fa ff ff       	jmp    80105a3a <alltraps>
...
80105f84:	6a 0b                	push   $0xb
  jmp alltraps
80105f86:	e9 af fa ff ff       	jmp    80105a3a <alltraps>
...
80105f8b:	6a 0c                	push   $0xc
  jmp alltraps
80105f8d:	e9 a8 fa ff ff       	jmp    80105a3a <alltraps>
...
80105f92:	6a 0d                	push   $0xd
  jmp alltraps
80105f94:	e9 a1 fa ff ff       	jmp    80105a3a <alltraps>
...
80105f99:	6a 0e                	push   $0xe
  jmp alltraps
80105f9b:	e9 9a fa ff ff       	jmp    80105a3a <alltraps>
...
80105fa2:	6a 0f                	push   $0xf
  jmp alltraps
80105fa4:	e9 91 fa ff ff       	jmp    80105a3a <alltraps>
...
80105fbb:	6a 12                	push   $0x12
  jmp alltraps
80105fbd:	e9 78 fa ff ff       	jmp    80105a3a <alltraps>
...
80105fc4:	6a 13                	push   $0x13
  jmp alltraps
80105fc6:	e9 6f fa ff ff       	jmp    80105a3a <alltraps>
...
80105fcd:	6a 14                	push   $0x14
  jmp alltraps
80105fcf:	e9 66 fa ff ff       	jmp    80105a3a <alltraps>
...
80105fd6:	6a 15                	push   $0x15
  jmp alltraps
80105fd8:	e9 5d fa ff ff       	jmp    80105a3a <alltraps>
...
80105fdf:	6a 16                	push   $0x16
  jmp alltraps
80105fe1:	e9 54 fa ff ff       	jmp    80105a3a <alltraps>
...
80105fe8:	6a 17                	push   $0x17
  jmp alltraps
80105fea:	e9 4b fa ff ff       	jmp    80105a3a <alltraps>
...
80105ff1:	6a 18                	push   $0x18
  jmp alltraps
80105ff3:	e9 42 fa ff ff       	jmp    80105a3a <alltraps>
...
80105ffa:	6a 19                	push   $0x19
  jmp alltraps
80105ffc:	e9 39 fa ff ff       	jmp    80105a3a <alltraps>
...
80106003:	6a 1a                	push   $0x1a
  jmp alltraps
80106005:	e9 30 fa ff ff       	jmp    80105a3a <alltraps>
...
8010600c:	6a 1b                	push   $0x1b
  jmp alltraps
8010600e:	e9 27 fa ff ff       	jmp    80105a3a <alltraps>
...
80106015:	6a 1c                	push   $0x1c
  jmp alltraps
80106017:	e9 1e fa ff ff       	jmp    80105a3a <alltraps>
...
8010601e:	6a 1d                	push   $0x1d
  jmp alltraps
80106020:	e9 15 fa ff ff       	jmp    80105a3a <alltraps>
...
80106027:	6a 1e                	push   $0x1e
  jmp alltraps
80106029:	e9 0c fa ff ff       	jmp    80105a3a <alltraps>
...
80106030:	6a 1f                	push   $0x1f
  jmp alltraps
80106032:	e9 03 fa ff ff       	jmp    80105a3a <alltraps>
...
80106039:	6a 20                	push   $0x20
  jmp alltraps
8010603b:	e9 fa f9 ff ff       	jmp    80105a3a <alltraps>
...
80106042:	6a 21                	push   $0x21
  jmp alltraps
80106044:	e9 f1 f9 ff ff       	jmp    80105a3a <alltraps>
...
8010604b:	6a 22                	push   $0x22
  jmp alltraps
8010604d:	e9 e8 f9 ff ff       	jmp    80105a3a <alltraps>
...
80106054:	6a 23                	push   $0x23
  jmp alltraps
80106056:	e9 df f9 ff ff       	jmp    80105a3a <alltraps>
...
8010605d:	6a 24                	push   $0x24
  jmp alltraps
8010605f:	e9 d6 f9 ff ff       	jmp    80105a3a <alltraps>
...
80106066:	6a 25                	push   $0x25
  jmp alltraps
80106068:	e9 cd f9 ff ff       	jmp    80105a3a <alltraps>
...
8010606f:	6a 26                	push   $0x26
  jmp alltraps
80106071:	e9 c4 f9 ff ff       	jmp    80105a3a <alltraps>
...
80106078:	6a 27                	push   $0x27
  jmp alltraps
8010607a:	e9 bb f9 ff ff       	jmp    80105a3a <alltraps>
...
80106081:	6a 28                	push   $0x28
  jmp alltraps
80106083:	e9 b2 f9 ff ff       	jmp    80105a3a <alltraps>
...
8010608a:	6a 29                	push   $0x29
  jmp alltraps
8010608c:	e9 a9 f9 ff ff       	jmp    80105a3a <alltraps>
...
80106093:	6a 2a                	push   $0x2a
  jmp alltraps
80106095:	e9 a0 f9 ff ff       	jmp    80105a3a <alltraps>
...
8010609c:	6a 2b                	push   $0x2b
  jmp alltraps
8010609e:	e9 97 f9 ff ff       	jmp    80105a3a <alltraps>
...
801060a5:	6a 2c                	push   $0x2c
  jmp alltraps
801060a7:	e9 8e f9 ff ff       	jmp    80105a3a <alltraps>
...
801060ae:	6a 2d                	push   $0x2d
  jmp alltraps
801060b0:	e9 85 f9 ff ff       	jmp    80105a3a <alltraps>
...
801060b7:	6a 2e                	push   $0x2e
  jmp alltraps
801060b9:	e9 7c f9 ff ff       	jmp    80105a3a <alltraps>
...
801060c0:	6a 2f                	push   $0x2f
  jmp alltraps
801060c2:	e9 73 f9 ff ff       	jmp    80105a3a <alltraps>
...
801060c9:	6a 30                	push   $0x30
  jmp alltraps
801060cb:	e9 6a f9 ff ff       	jmp    80105a3a <alltraps>
...
801060d2:	6a 31                	push   $0x31
  jmp alltraps
801060d4:	e9 61 f9 ff ff       	jmp    80105a3a <alltraps>
...
801060db:	6a 32                	push   $0x32
  jmp alltraps
801060dd:	e9 58 f9 ff ff       	jmp    80105a3a <alltraps>
...
801060e4:	6a 33                	push   $0x33
  jmp alltraps
801060e6:	e9 4f f9 ff ff       	jmp    80105a3a <alltraps>
...
801060ed:	6a 34                	push   $0x34
  jmp alltraps
801060ef:	e9 46 f9 ff ff       	jmp    80105a3a <alltraps>
...
801060f6:	6a 35                	push   $0x35
  jmp alltraps
801060f8:	e9 3d f9 ff ff       	jmp    80105a3a <alltraps>
...
801060ff:	6a 36                	push   $0x36
  jmp alltraps
80106101:	e9 34 f9 ff ff       	jmp    80105a3a <alltraps>
...
80106108:	6a 37                	push   $0x37
  jmp alltraps
8010610a:	e9 2b f9 ff ff       	jmp    80105a3a <alltraps>
...
80106111:	6a 38                	push   $0x38
  jmp alltraps
80106113:	e9 22 f9 ff ff       	jmp    80105a3a <alltraps>
...
8010611a:	6a 39                	push   $0x39
  jmp alltraps
8010611c:	e9 19 f9 ff ff       	jmp    80105a3a <alltraps>
...
80106123:	6a 3a                	push   $0x3a
  jmp alltraps
80106125:	e9 10 f9 ff ff       	jmp    80105a3a <alltraps>
...
8010612c:	6a 3b                	push   $0x3b
  jmp alltraps
8010612e:	e9 07 f9 ff ff       	jmp    80105a3a <alltraps>
...
80106135:	6a 3c                	push   $0x3c
  jmp alltraps
80106137:	e9 fe f8 ff ff       	jmp    80105a3a <alltraps>
...
8010613e:	6a 3d                	push   $0x3d
  jmp alltraps
80106140:	e9 f5 f8 ff ff       	jmp    80105a3a <alltraps>
...
80106147:	6a 3e                	push   $0x3e
  jmp alltraps
80106149:	e9 ec f8 ff ff       	jmp    80105a3a <alltraps>
...
80106150:	6a 3f                	push   $0x3f
  jmp alltraps
80106152:	e9 e3 f8 ff ff       	jmp    80105a3a <alltraps>
...
80106159:	6a 40                	push   $0x40
  jmp alltraps
8010615b:	e9 da f8 ff ff       	jmp    80105a3a <alltraps>
...
80106162:	6a 41                	push   $0x41
  jmp alltraps
80106164:	e9 d1 f8 ff ff       	jmp    80105a3a <alltraps>
...
8010616b:	6a 42                	push   $0x42
  jmp alltraps
8010616d:	e9 c8 f8 ff ff       	jmp    80105a3a <alltraps>
...
80106174:	6a 43                	push   $0x43
  jmp alltraps
80106176:	e9 bf f8 ff ff       	jmp    80105a3a <alltraps>
...
8010617d:	6a 44                	push   $0x44
  jmp alltraps
8010617f:	e9 b6 f8 ff ff       	jmp    80105a3a <alltraps>
...
80106186:	6a 45                	push   $0x45
  jmp alltraps
80106188:	e9 ad f8 ff ff       	jmp    80105a3a <alltraps>
...
8010618f:	6a 46                	push   $0x46
  jmp alltraps
80106191:	e9 a4 f8 ff ff       	jmp    80105a3a <alltraps>
...
80106198:	6a 47                	push   $0x47
  jmp alltraps
8010619a:	e9 9b f8 ff ff       	jmp    80105a3a <alltraps>
...
801061a1:	6a 48                	push   $0x48
  jmp alltraps
801061a3:	e9 92 f8 ff ff       	jmp    80105a3a <alltraps>
...
801061aa:	6a 49                	push   $0x49
  jmp alltraps
801061ac:	e9 89 f8 ff ff       	jmp    80105a3a <alltraps>
...
801061b3:	6a 4a                	push   $0x4a
  jmp alltraps
801061b5:	e9 80 f8 ff ff       	jmp    80105a3a <alltraps>
...
801061bc:	6a 4b                	push   $0x4b
  jmp alltraps
801061be:	e9 77 f8 ff ff       	jmp    80105a3a <alltraps>
...
801061c5:	6a 4c                	push   $0x4c
  jmp alltraps
801061c7:	e9 6e f8 ff ff       	jmp    80105a3a <alltraps>
...
801061ce:	6a 4d                	push   $0x4d
  jmp alltraps
801061d0:	e9 65 f8 ff ff       	jmp    80105a3a <alltraps>
...
801061d7:	6a 4e                	push   $0x4e
  jmp alltraps
801061d9:	e9 5c f8 ff ff       	jmp    80105a3a <alltraps>
...
801061e0:	6a 4f                	push   $0x4f
  jmp alltraps
801061e2:	e9 53 f8 ff ff       	jmp    80105a3a <alltraps>
...
801061e9:	6a 50                	push   $0x50
  jmp alltraps
801061eb:	e9 4a f8 ff ff       	jmp    80105a3a <alltraps>
...
801061f2:	6a 51                	push   $0x51
  jmp alltraps
801061f4:	e9 41 f8 ff ff       	jmp    80105a3a <alltraps>
...
801061fb:	6a 52                	push   $0x52
  jmp alltraps
801061fd:	e9 38 f8 ff ff       	jmp    80105a3a <alltraps>
...
80106204:	6a 53                	push   $0x53
  jmp alltraps
80106206:	e9 2f f8 ff ff       	jmp    80105a3a <alltraps>
...
8010620d:	6a 54                	push   $0x54
  jmp alltraps
8010620f:	e9 26 f8 ff ff       	jmp    80105a3a <alltraps>
...
80106216:	6a 55                	push   $0x55
  jmp alltraps
80106218:	e9 1d f8 ff ff       	jmp    80105a3a <alltraps>
...
8010621f:	6a 56                	push   $0x56
  jmp alltraps
80106221:	e9 14 f8 ff ff       	jmp    80105a3a <alltraps>
...
80106228:	6a 57                	push   $0x57
  jmp alltraps
8010622a:	e9 0b f8 ff ff       	jmp    80105a3a <alltraps>
...
80106231:	6a 58                	push   $0x58
  jmp alltraps
80106233:	e9 02 f8 ff ff       	jmp    80105a3a <alltraps>
...
8010623a:	6a 59                	push   $0x59
  jmp alltraps
8010623c:	e9 f9 f7 ff ff       	jmp    80105a3a <alltraps>
...
80106243:	6a 5a                	push   $0x5a
  jmp alltraps
80106245:	e9 f0 f7 ff ff       	jmp    80105a3a <alltraps>
...
8010624c:	6a 5b                	push   $0x5b
  jmp alltraps
8010624e:	e9 e7 f7 ff ff       	jmp    80105a3a <alltraps>
...
80106255:	6a 5c                	push   $0x5c
  jmp alltraps
80106257:	e9 de f7 ff ff       	jmp    80105a3a <alltraps>
...
8010625e:	6a 5d                	push   $0x5d
  jmp alltraps
80106260:	e9 d5 f7 ff ff       	jmp    80105a3a <alltraps>
...
80106267:	6a 5e                	push   $0x5e
  jmp alltraps
80106269:	e9 cc f7 ff ff       	jmp    80105a3a <alltraps>
...
80106270:	6a 5f                	push   $0x5f
  jmp alltraps
80106272:	e9 c3 f7 ff ff       	jmp    80105a3a <alltraps>
...
80106279:	6a 60                	push   $0x60
  jmp alltraps
8010627b:	e9 ba f7 ff ff       	jmp    80105a3a <alltraps>
...
80106282:	6a 61                	push   $0x61
  jmp alltraps
80106284:	e9 b1 f7 ff ff       	jmp    80105a3a <alltraps>
...
8010628b:	6a 62                	push   $0x62
  jmp alltraps
8010628d:	e9 a8 f7 ff ff       	jmp    80105a3a <alltraps>
...
80106294:	6a 63                	push   $0x63
  jmp alltraps
80106296:	e9 9f f7 ff ff       	jmp    80105a3a <alltraps>
...
8010629d:	6a 64                	push   $0x64
  jmp alltraps
8010629f:	e9 96 f7 ff ff       	jmp    80105a3a <alltraps>
...
801062a6:	6a 65                	push   $0x65
  jmp alltraps
801062a8:	e9 8d f7 ff ff       	jmp    80105a3a <alltraps>
...
801062af:	6a 66                	push   $0x66
  jmp alltraps
801062b1:	e9 84 f7 ff ff       	jmp    80105a3a <alltraps>
...
801062b8:	6a 67                	push   $0x67
  jmp alltraps
801062ba:	e9 7b f7 ff ff       	jmp    80105a3a <alltraps>
...
801062c1:	6a 68                	push   $0x68
  jmp alltraps
801062c3:	e9 72 f7 ff ff       	jmp    80105a3a <alltraps>
...
801062ca:	6a 69                	push   $0x69
  jmp alltraps
801062cc:	e9 69 f7 ff ff       	jmp    80105a3a <alltraps>
...
801062d3:	6a 6a                	push   $0x6a
  jmp alltraps
801062d5:	e9 60 f7 ff ff       	jmp    80105a3a <alltraps>
...
801062dc:	6a 6b                	push   $0x6b
  jmp alltraps
801062de:	e9 57 f7 ff ff       	jmp    80105a3a <alltraps>
...
801062e5:	6a 6c                	push   $0x6c
  jmp alltraps
801062e7:	e9 4e f7 ff ff       	jmp    80105a3a <alltraps>
...
801062ee:	6a 6d                	push   $0x6d
  jmp alltraps
801062f0:	e9 45 f7 ff ff       	jmp    80105a3a <alltraps>
...
801062f7:	6a 6e                	push   $0x6e
  jmp alltraps
801062f9:	e9 3c f7 ff ff       	jmp    80105a3a <alltraps>
...
80106300:	6a 6f                	push   $0x6f
  jmp alltraps
80106302:	e9 33 f7 ff ff       	jmp    80105a3a <alltraps>
...
80106309:	6a 70                	push   $0x70
  jmp alltraps
8010630b:	e9 2a f7 ff ff       	jmp    80105a3a <alltraps>
...
80106312:	6a 71                	push   $0x71
  jmp alltraps
80106314:	e9 21 f7 ff ff       	jmp    80105a3a <alltraps>
...
8010631b:	6a 72                	push   $0x72
  jmp alltraps
8010631d:	e9 18 f7 ff ff       	jmp    80105a3a <alltraps>
...
80106324:	6a 73                	push   $0x73
  jmp alltraps
80106326:	e9 0f f7 ff ff       	jmp    80105a3a <alltraps>
...
8010632d:	6a 74                	push   $0x74
  jmp alltraps
8010632f:	e9 06 f7 ff ff       	jmp    80105a3a <alltraps>
...
80106336:	6a 75                	push   $0x75
  jmp alltraps
80106338:	e9 fd f6 ff ff       	jmp    80105a3a <alltraps>
...
8010633f:	6a 76                	push   $0x76
  jmp alltraps
80106341:	e9 f4 f6 ff ff       	jmp    80105a3a <alltraps>
...
80106348:	6a 77                	push   $0x77
  jmp alltraps
8010634a:	e9 eb f6 ff ff       	jmp    80105a3a <alltraps>
...
80106351:	6a 78                	push   $0x78
  jmp alltraps
80106353:	e9 e2 f6 ff ff       	jmp    80105a3a <alltraps>
...
8010635a:	6a 79                	push   $0x79
  jmp alltraps
8010635c:	e9 d9 f6 ff ff       	jmp    80105a3a <alltraps>
...
80106363:	6a 7a                	push   $0x7a
  jmp alltraps
80106365:	e9 d0 f6 ff ff       	jmp    80105a3a <alltraps>
...
8010636c:	6a 7b                	push   $0x7b
  jmp alltraps
8010636e:	e9 c7 f6 ff ff       	jmp    80105a3a <alltraps>
...
80106375:	6a 7c                	push   $0x7c
  jmp alltraps
80106377:	e9 be f6 ff ff       	jmp    80105a3a <alltraps>
...
8010637e:	6a 7d                	push   $0x7d
  jmp alltraps
80106380:	e9 b5 f6 ff ff       	jmp    80105a3a <alltraps>
...
80106387:	6a 7e                	push   $0x7e
  jmp alltraps
80106389:	e9 ac f6 ff ff       	jmp    80105a3a <alltraps>
...
80106390:	6a 7f                	push   $0x7f
  jmp alltraps
80106392:	e9 a3 f6 ff ff       	jmp    80105a3a <alltraps>
...
80106399:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010639e:	e9 97 f6 ff ff       	jmp    80105a3a <alltraps>
...
801063a5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063aa:	e9 8b f6 ff ff       	jmp    80105a3a <alltraps>
...
801063b1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063b6:	e9 7f f6 ff ff       	jmp    80105a3a <alltraps>
...
801063bd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063c2:	e9 73 f6 ff ff       	jmp    80105a3a <alltraps>
...
801063c9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063ce:	e9 67 f6 ff ff       	jmp    80105a3a <alltraps>
...
801063d5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063da:	e9 5b f6 ff ff       	jmp    80105a3a <alltraps>
...
801063e1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801063e6:	e9 4f f6 ff ff       	jmp    80105a3a <alltraps>
...
801063ed:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801063f2:	e9 43 f6 ff ff       	jmp    80105a3a <alltraps>
...
801063f9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801063fe:	e9 37 f6 ff ff       	jmp    80105a3a <alltraps>
...
80106405:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010640a:	e9 2b f6 ff ff       	jmp    80105a3a <alltraps>
...
80106411:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106416:	e9 1f f6 ff ff       	jmp    80105a3a <alltraps>
...
8010641d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106422:	e9 13 f6 ff ff       	jmp    80105a3a <alltraps>
...
80106429:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010642e:	e9 07 f6 ff ff       	jmp    80105a3a <alltraps>
...
80106435:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010643a:	e9 fb f5 ff ff       	jmp    80105a3a <alltraps>
...
80106441:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106446:	e9 ef f5 ff ff       	jmp    80105a3a <alltraps>
...
8010644d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106452:	e9 e3 f5 ff ff       	jmp    80105a3a <alltraps>
...
80106459:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010645e:	e9 d7 f5 ff ff       	jmp    80105a3a <alltraps>
...
80106465:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010646a:	e9 cb f5 ff ff       	jmp    80105a3a <alltraps>
...
80106471:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106476:	e9 bf f5 ff ff       	jmp    80105a3a <alltraps>
...
8010647d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106482:	e9 b3 f5 ff ff       	jmp    80105a3a <alltraps>
...
80106489:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010648e:	e9 a7 f5 ff ff       	jmp    80105a3a <alltraps>
...
80106495:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010649a:	e9 9b f5 ff ff       	jmp    80105a3a <alltraps>
...
801064a1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064a6:	e9 8f f5 ff ff       	jmp    80105a3a <alltraps>
...
801064ad:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064b2:	e9 83 f5 ff ff       	jmp    80105a3a <alltraps>
...
801064b9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064be:	e9 77 f5 ff ff       	jmp    80105a3a <alltraps>
...
801064c5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064ca:	e9 6b f5 ff ff       	jmp    80105a3a <alltraps>
...
801064d1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064d6:	e9 5f f5 ff ff       	jmp    80105a3a <alltraps>
...
801064dd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801064e2:	e9 53 f5 ff ff       	jmp    80105a3a <alltraps>
...
801064e9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801064ee:	e9 47 f5 ff ff       	jmp    80105a3a <alltraps>
...
801064f5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801064fa:	e9 3b f5 ff ff       	jmp    80105a3a <alltraps>
...
80106501:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106506:	e9 2f f5 ff ff       	jmp    80105a3a <alltraps>
...
8010650d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106512:	e9 23 f5 ff ff       	jmp    80105a3a <alltraps>
...
80106519:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010651e:	e9 17 f5 ff ff       	jmp    80105a3a <alltraps>
...
80106525:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010652a:	e9 0b f5 ff ff       	jmp    80105a3a <alltraps>
...
80106531:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106536:	e9 ff f4 ff ff       	jmp    80105a3a <alltraps>
...
8010653d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106542:	e9 f3 f4 ff ff       	jmp    80105a3a <alltraps>
...
80106549:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010654e:	e9 e7 f4 ff ff       	jmp    80105a3a <alltraps>
...
80106555:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010655a:	e9 db f4 ff ff       	jmp    80105a3a <alltraps>
...
80106561:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106566:	e9 cf f4 ff ff       	jmp    80105a3a <alltraps>
...
8010656d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106572:	e9 c3 f4 ff ff       	jmp    80105a3a <alltraps>
...
80106579:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010657e:	e9 b7 f4 ff ff       	jmp    80105a3a <alltraps>
...
80106585:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010658a:	e9 ab f4 ff ff       	jmp    80105a3a <alltraps>
...
80106591:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106596:	e9 9f f4 ff ff       	jmp    80105a3a <alltraps>
...
8010659d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065a2:	e9 93 f4 ff ff       	jmp    80105a3a <alltraps>
...
801065a9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065ae:	e9 87 f4 ff ff       	jmp    80105a3a <alltraps>
...
801065b5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065ba:	e9 7b f4 ff ff       	jmp    80105a3a <alltraps>
...
801065c1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065c6:	e9 6f f4 ff ff       	jmp    80105a3a <alltraps>
...
801065cd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065d2:	e9 63 f4 ff ff       	jmp    80105a3a <alltraps>
...
801065d9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065de:	e9 57 f4 ff ff       	jmp    80105a3a <alltraps>
...
801065e5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801065ea:	e9 4b f4 ff ff       	jmp    80105a3a <alltraps>
...
801065f1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801065f6:	e9 3f f4 ff ff       	jmp    80105a3a <alltraps>
...
801065fd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106602:	e9 33 f4 ff ff       	jmp    80105a3a <alltraps>
...
80106609:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010660e:	e9 27 f4 ff ff       	jmp    80105a3a <alltraps>
...
80106615:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010661a:	e9 1b f4 ff ff       	jmp    80105a3a <alltraps>
...
80106621:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106626:	e9 0f f4 ff ff       	jmp    80105a3a <alltraps>
...
8010662d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106632:	e9 03 f4 ff ff       	jmp    80105a3a <alltraps>
...
80106639:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010663e:	e9 f7 f3 ff ff       	jmp    80105a3a <alltraps>
...
80106645:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010664a:	e9 eb f3 ff ff       	jmp    80105a3a <alltraps>
...
80106651:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106656:	e9 df f3 ff ff       	jmp    80105a3a <alltraps>
...
8010665d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106662:	e9 d3 f3 ff ff       	jmp    80105a3a <alltraps>
...
80106669:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010666e:	e9 c7 f3 ff ff       	jmp    80105a3a <alltraps>
...
80106675:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010667a:	e9 bb f3 ff ff       	jmp    80105a3a <alltraps>
...
80106681:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106686:	e9 af f3 ff ff       	jmp    80105a3a <alltraps>
...
8010668d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106692:	e9 a3 f3 ff ff       	jmp    80105a3a <alltraps>
...
80106699:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010669e:	e9 97 f3 ff ff       	jmp    80105a3a <alltraps>
...
801066a5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066aa:	e9 8b f3 ff ff       	jmp    80105a3a <alltraps>
...
801066b1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066b6:	e9 7f f3 ff ff       	jmp    80105a3a <alltraps>
...
801066bd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066c2:	e9 73 f3 ff ff       	jmp    80105a3a <alltraps>
...
801066c9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066ce:	e9 67 f3 ff ff       	jmp    80105a3a <alltraps>
...
801066d5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066da:	e9 5b f3 ff ff       	jmp    80105a3a <alltraps>
...
801066e1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801066e6:	e9 4f f3 ff ff       	jmp    80105a3a <alltraps>
...
801066ed:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801066f2:	e9 43 f3 ff ff       	jmp    80105a3a <alltraps>
...
801066f9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801066fe:	e9 37 f3 ff ff       	jmp    80105a3a <alltraps>
...
80106705:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010670a:	e9 2b f3 ff ff       	jmp    80105a3a <alltraps>
...
80106711:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106716:	e9 1f f3 ff ff       	jmp    80105a3a <alltraps>
...
8010671d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106722:	e9 13 f3 ff ff       	jmp    80105a3a <alltraps>
...
80106729:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010672e:	e9 07 f3 ff ff       	jmp    80105a3a <alltraps>
...
80106735:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010673a:	e9 fb f2 ff ff       	jmp    80105a3a <alltraps>
...
80106741:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106746:	e9 ef f2 ff ff       	jmp    80105a3a <alltraps>
...
8010674d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106752:	e9 e3 f2 ff ff       	jmp    80105a3a <alltraps>
...
80106759:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010675e:	e9 d7 f2 ff ff       	jmp    80105a3a <alltraps>
...
80106765:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010676a:	e9 cb f2 ff ff       	jmp    80105a3a <alltraps>
...
80106771:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106776:	e9 bf f2 ff ff       	jmp    80105a3a <alltraps>
...
8010677d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106782:	e9 b3 f2 ff ff       	jmp    80105a3a <alltraps>
...
80106789:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010678e:	e9 a7 f2 ff ff       	jmp    80105a3a <alltraps>
...
80106795:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010679a:	e9 9b f2 ff ff       	jmp    80105a3a <alltraps>
...
801067a1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067a6:	e9 8f f2 ff ff       	jmp    80105a3a <alltraps>
...
801067ad:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067b2:	e9 83 f2 ff ff       	jmp    80105a3a <alltraps>
...
801067b9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067be:	e9 77 f2 ff ff       	jmp    80105a3a <alltraps>
...
801067c5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067ca:	e9 6b f2 ff ff       	jmp    80105a3a <alltraps>
...
801067d1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067d6:	e9 5f f2 ff ff       	jmp    80105a3a <alltraps>
...
801067dd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801067e2:	e9 53 f2 ff ff       	jmp    80105a3a <alltraps>
...
801067e9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801067ee:	e9 47 f2 ff ff       	jmp    80105a3a <alltraps>
...
801067f5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801067fa:	e9 3b f2 ff ff       	jmp    80105a3a <alltraps>
...
80106801:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106806:	e9 2f f2 ff ff       	jmp    80105a3a <alltraps>
...
8010680d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106812:	e9 23 f2 ff ff       	jmp    80105a3a <alltraps>
...
80106819:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010681e:	e9 17 f2 ff ff       	jmp    80105a3a <alltraps>
...
80106825:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010682a:	e9 0b f2 ff ff       	jmp    80105a3a <alltraps>
...
80106831:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106836:	e9 ff f1 ff ff       	jmp    80105a3a <alltraps>
...
8010683d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106842:	e9 f3 f1 ff ff       	jmp    80105a3a <alltraps>
...
80106849:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010684e:	e9 e7 f1 ff ff       	jmp    80105a3a <alltraps>
...
80106855:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010685a:	e9 db f1 ff ff       	jmp    80105a3a <alltraps>
...
80106861:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106866:	e9 cf f1 ff ff       	jmp    80105a3a <alltraps>
...
8010686d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106872:	e9 c3 f1 ff ff       	jmp    80105a3a <alltraps>
...
80106879:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010687e:	e9 b7 f1 ff ff       	jmp    80105a3a <alltraps>
...
80106885:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010688a:	e9 ab f1 ff ff       	jmp    80105a3a <alltraps>
...
80106891:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106896:	e9 9f f1 ff ff       	jmp    80105a3a <alltraps>
...
8010689d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068a2:	e9 93 f1 ff ff       	jmp    80105a3a <alltraps>
...
801068a9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068ae:	e9 87 f1 ff ff       	jmp    80105a3a <alltraps>
...
801068b5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068ba:	e9 7b f1 ff ff       	jmp    80105a3a <alltraps>
...
801068c1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068c6:	e9 6f f1 ff ff       	jmp    80105a3a <alltraps>
...
801068cd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068d2:	e9 63 f1 ff ff       	jmp    80105a3a <alltraps>
...
801068d9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068de:	e9 57 f1 ff ff       	jmp    80105a3a <alltraps>
...
801068e5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801068ea:	e9 4b f1 ff ff       	jmp    80105a3a <alltraps>
...
801068f1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801068f6:	e9 3f f1 ff ff       	jmp    80105a3a <alltraps>
...
801068fd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106902:	e9 33 f1 ff ff       	jmp    80105a3a <alltraps>
...
80106909:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010690e:	e9 27 f1 ff ff       	jmp    80105a3a <alltraps>
...
80106915:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010691a:	e9 1b f1 ff ff       	jmp    80105a3a <alltraps>
...
80106921:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106926:	e9 0f f1 ff ff       	jmp    80105a3a <alltraps>
...
8010692d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106932:	e9 03 f1 ff ff       	jmp    80105a3a <alltraps>
...
80106939:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010693e:	e9 f7 f0 ff ff       	jmp    80105a3a <alltraps>
...
80106945:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010694a:	e9 eb f0 ff ff       	jmp    80105a3a <alltraps>
...
80106951:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106956:	e9 df f0 ff ff       	jmp    80105a3a <alltraps>
...
8010695d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106962:	e9 d3 f0 ff ff       	jmp    80105a3a <alltraps>
...
80106969:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010696e:	e9 c7 f0 ff ff       	jmp    80105a3a <alltraps>
...
80106975:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010697a:	e9 bb f0 ff ff       	jmp    80105a3a <alltraps>
...
80106981:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106986:	e9 af f0 ff ff       	jmp    80105a3a <alltraps>
...
8010698d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106992:	e9 a3 f0 ff ff       	jmp    80105a3a <alltraps>
...
801069b5:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801069b8:	39 d3                	cmp    %edx,%ebx
801069ba:	73 49                	jae    80106a05 <deallocuvm.part.0+0x65>
801069bc:	89 c7                	mov    %eax,%edi
801069be:	eb 0c                	jmp    801069cc <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801069c0:	83 c0 01             	add    $0x1,%eax
801069c3:	c1 e0 16             	shl    $0x16,%eax
801069c6:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
801069c8:	39 da                	cmp    %ebx,%edx
801069ca:	76 39                	jbe    80106a05 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
801069cc:	89 d8                	mov    %ebx,%eax
801069ce:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
801069d1:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
801069d4:	f6 c1 01             	test   $0x1,%cl
801069d7:	74 e7                	je     801069c0 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
801069d9:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801069db:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
801069e1:	c1 ee 0a             	shr    $0xa,%esi
801069e4:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
801069ea:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
801069f1:	85 f6                	test   %esi,%esi
801069f3:	74 cb                	je     801069c0 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
801069f5:	8b 06                	mov    (%esi),%eax
801069f7:	a8 01                	test   $0x1,%al
801069f9:	75 15                	jne    80106a10 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
801069fb:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106a01:	39 da                	cmp    %ebx,%edx
80106a03:	77 c7                	ja     801069cc <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
80106a05:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106a15:	74 25                	je     80106a3c <deallocuvm.part.0+0x9c>
      kfree(v);
80106a17:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106a1a:	05 00 00 00 80       	add    $0x80000000,%eax
80106a1f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106a22:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106a28:	50                   	push   %eax
80106a29:	e8 92 ba ff ff       	call   801024c0 <kfree>
      *pte = 0;
80106a2e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
80106a34:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106a37:	83 c4 10             	add    $0x10,%esp
80106a3a:	eb 8c                	jmp    801069c8 <deallocuvm.part.0+0x28>
        panic("kfree");
80106a3c:	83 ec 0c             	sub    $0xc,%esp
80106a3f:	68 06 76 10 80       	push   $0x80107606
80106a44:	e8 37 99 ff ff       	call   80100380 <panic>
...
80106a78:	eb 3d                	jmp    80106ab7 <mappages+0x67>
...
80106aaa:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106aac:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
80106aaf:	74 6f                	je     80106b20 <mappages+0xd0>
    a += PGSIZE;
80106ab1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80106ab7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
80106aba:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106abd:	8d 34 18             	lea    (%eax,%ebx,1),%esi
80106ac0:	89 d8                	mov    %ebx,%eax
80106ac2:	c1 e8 16             	shr    $0x16,%eax
80106ac5:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80106ac8:	8b 07                	mov    (%edi),%eax
80106aca:	a8 01                	test   $0x1,%al
80106acc:	75 b2                	jne    80106a80 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106ace:	e8 ad bb ff ff       	call   80102680 <kalloc>
80106ad3:	85 c0                	test   %eax,%eax
80106ad5:	74 39                	je     80106b10 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106ad7:	83 ec 04             	sub    $0x4,%esp
80106ada:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106add:	68 00 10 00 00       	push   $0x1000
80106ae2:	6a 00                	push   $0x0
80106ae4:	50                   	push   %eax
80106ae5:	e8 96 dc ff ff       	call   80104780 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106aea:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
80106aed:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106af0:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106af6:	83 c8 07             	or     $0x7,%eax
80106af9:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
80106afb:	89 d8                	mov    %ebx,%eax
80106afd:	c1 e8 0a             	shr    $0xa,%eax
80106b00:	25 fc 0f 00 00       	and    $0xffc,%eax
80106b05:	01 d0                	add    %edx,%eax
80106b07:	eb 92                	jmp    80106a9b <mappages+0x4b>
...
80106b2d:	68 50 7c 10 80       	push   $0x80107c50
...
80106bd0:	a1 e4 46 11 80       	mov    0x801146e4,%eax
...
80106c04:	0f 84 c2 00 00 00    	je     80106ccc <switchuvm+0xec>
  pushcli();
80106c0a:	e8 61 d9 ff ff       	call   80104570 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c0f:	e8 ec cc ff ff       	call   80103900 <mycpu>
80106c14:	89 c3                	mov    %eax,%ebx
80106c16:	e8 e5 cc ff ff       	call   80103900 <mycpu>
...
80106c28:	e8 d3 cc ff ff       	call   80103900 <mycpu>
...
80106cff:	8b 7d 08             	mov    0x8(%ebp),%edi
80106d02:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106d05:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106d0b:	77 4b                	ja     80106d58 <inituvm+0x68>
  mem = kalloc();
80106d0d:	e8 6e b9 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106d38:	e8 13 fd ff ff       	call   80106a50 <mappages>
  memmove(mem, init, sz);
80106d3d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d40:	89 75 10             	mov    %esi,0x10(%ebp)
80106d43:	83 c4 10             	add    $0x10,%esp
80106d46:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106d49:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106d52:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d53:	e9 c8 da ff ff       	jmp    80104820 <memmove>
    panic("inituvm: more than a page");
80106d58:	83 ec 0c             	sub    $0xc,%esp
80106d5b:	68 95 7c 10 80       	push   $0x80107c95
80106d60:	e8 1b 96 ff ff       	call   80100380 <panic>
80106d65:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80106d84:	0f 85 bb 00 00 00    	jne    80106e45 <loaduvm+0xd5>
...
80106d9b:	0f 84 87 00 00 00    	je     80106e28 <loaduvm+0xb8>
80106da1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80106da8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
80106dab:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106dae:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80106db0:	89 c2                	mov    %eax,%edx
80106db2:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80106db5:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80106db8:	f6 c2 01             	test   $0x1,%dl
80106dbb:	75 13                	jne    80106dd0 <loaduvm+0x60>
      panic("loaduvm: address should exist");
80106dbd:	83 ec 0c             	sub    $0xc,%esp
80106dc0:	68 af 7c 10 80       	push   $0x80107caf
80106dc5:	e8 b6 95 ff ff       	call   80100380 <panic>
80106dca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106dd0:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106dd3:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80106dd9:	25 fc 0f 00 00       	and    $0xffc,%eax
80106dde:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106de5:	85 c0                	test   %eax,%eax
80106de7:	74 d4                	je     80106dbd <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
...
80106e0b:	ff 75 10             	push   0x10(%ebp)
80106e0e:	e8 7d ac ff ff       	call   80101a90 <readi>
80106e13:	83 c4 10             	add    $0x10,%esp
80106e16:	39 f8                	cmp    %edi,%eax
80106e18:	75 1e                	jne    80106e38 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106e1a:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106e20:	89 f0                	mov    %esi,%eax
80106e22:	29 d8                	sub    %ebx,%eax
80106e24:	39 c6                	cmp    %eax,%esi
80106e26:	77 80                	ja     80106da8 <loaduvm+0x38>
}
...
80106e48:	68 50 7d 10 80       	push   $0x80107d50
...
80106e66:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80106e69:	8b 45 10             	mov    0x10(%ebp),%eax
{
80106e6c:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106e6f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e72:	85 c0                	test   %eax,%eax
80106e74:	0f 88 b6 00 00 00    	js     80106f30 <allocuvm+0xd0>
  if(newsz < oldsz)
80106e7a:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106e7d:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106e80:	0f 82 9a 00 00 00    	jb     80106f20 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106e86:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106e8c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106e92:	39 75 10             	cmp    %esi,0x10(%ebp)
80106e95:	77 44                	ja     80106edb <allocuvm+0x7b>
80106e97:	e9 87 00 00 00       	jmp    80106f23 <allocuvm+0xc3>
...
80106eab:	e8 d0 d8 ff ff       	call   80104780 <memset>
...
80106ec4:	e8 87 fb ff ff       	call   80106a50 <mappages>
...
80106ed9:	76 48                	jbe    80106f23 <allocuvm+0xc3>
    mem = kalloc();
80106edb:	e8 a0 b7 ff ff       	call   80102680 <kalloc>
...
80106ee9:	68 cd 7c 10 80       	push   $0x80107ccd
80106eee:	e8 ad 97 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
80106f05:	e8 96 fa ff ff       	call   801069a0 <deallocuvm.part.0>
      return 0;
...
80106f4b:	68 e5 7c 10 80       	push   $0x80107ce5
80106f50:	e8 4b 97 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
80106f67:	e8 34 fa ff ff       	call   801069a0 <deallocuvm.part.0>
      kfree(mem);
80106f6c:	83 ec 0c             	sub    $0xc,%esp
80106f6f:	53                   	push   %ebx
80106f70:	e8 4b b5 ff ff       	call   801024c0 <kfree>
      return 0;
...
8010700e:	e8 ad b4 ff ff       	call   801024c0 <kfree>
...
80107023:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107024:	e9 97 b4 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80107029:	83 ec 0c             	sub    $0xc,%esp
8010702c:	68 01 7d 10 80       	push   $0x80107d01
...
80107060:	e8 1b d7 ff ff       	call   80104780 <memset>
...
80107071:	ff 73 0c             	push   0xc(%ebx)
80107074:	8b 13                	mov    (%ebx),%edx
80107076:	50                   	push   %eax
80107077:	29 c1                	sub    %eax,%ecx
80107079:	89 f0                	mov    %esi,%eax
8010707b:	e8 d0 f9 ff ff       	call   80106a50 <mappages>
...
801070cb:	a3 e4 46 11 80       	mov    %eax,0x801146e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801070fc:	68 12 7d 10 80       	push   $0x80107d12
...
80107143:	0f 84 bd 00 00 00    	je     80107206 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80107172:	68 1c 7d 10 80       	push   $0x80107d1c
...
801071d0:	e8 4b d6 ff ff       	call   80104820 <memmove>
...
801071eb:	e8 60 f8 ff ff       	call   80106a50 <mappages>
...
80107200:	0f 87 5a ff ff ff    	ja     80107160 <copyuvm+0x30>
  return d;
...
8010721c:	e8 9f b2 ff ff       	call   801024c0 <kfree>
      goto bad;
...
8010722a:	e8 91 fd ff ff       	call   80106fc0 <freevm>
  return 0;
8010722f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107247:	68 36 7d 10 80       	push   $0x80107d36
...
80107300:	e8 1b d5 ff ff       	call   80104820 <memmove>
    len -= n;
    buf += n;
